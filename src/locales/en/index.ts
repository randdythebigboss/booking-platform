...
export const en: Translations = {
  ...
  appointments: {
    ...
    emptyUpcomingHint: 'When somebody books, it will show up here.',
    emptyOtherHint: 'Try another period or another status.',
  ...
  calendar: {
    ...
    appointmentsThatDay_one: '{{count}} appointment',
    appointmentsThatDay_other: '{{count}} appointments',
    cancelledThatDay_one: '{{count}} cancelled',
    cancelledThatDay_other: '{{count}} cancelled',
    nothingThatDayHint: 'That day is free.',
    seeAll: 'See all',
    comingUp: 'Coming up',
  ...
  settings: {
    sectionSaved: 'Saved.',
    businessSection: 'Business and public page',
    businessSectionHint: 'What a customer sees before booking.',
    profileSection: 'Your professional profile',
    profileSectionHint: 'How you appear inside the business.',
    rulesSection: 'Booking rules',
    rulesSectionHint: 'Which times are offered, and how far ahead.',
  ...
  azul: {
    connect: 'Connect Azul — coming soon',
    connectHint: 'You will need your own merchant account with Azul.',
