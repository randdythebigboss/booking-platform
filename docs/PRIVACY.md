...
| **Business details** — name, slug, description, phone, email, address, timezone           | `public.businesses`                               | The public booking page, and where notifications to the shop go               | Anyone, for a _published_ business — this is the shop's shopfront                                |
